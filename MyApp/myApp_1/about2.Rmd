...
For people want to see the whole picture of the dataset, you can choose the Jitter checkbox and it will add random noises to aviod the covering issue.
```
```{}
...
Facet Row allow you to devide the plot horizontally. Lets continue with the example above.
Suppose you choose gear in the Facet Row, you can see that the plot has been divided horizontally into 3 parts. Recall that the variable gear has 3 levels, now you can tell from the plot that there are totally 13 cars with 3 gears and coincidently they are all automatic cars; at the meantime, there are totally 5 cars with 5 gears and incidentally they are all manual cars.
See? The facet option can separate the samples in the dataset and can also reflect another dimention of the samples.
Of course, the Facet Column allow you to divide the plot vertically.
You can simultaneously assign differen values to Facet Row and Facet Column, therefore divide the plot into more pieces.
```